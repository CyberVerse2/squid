export function ChatHeader() {
  return (
    <div className=" mx-auto flex justify-between items-center px-6 py-4 border-b-2 border-gray-200 bg-white sticky top-0">
      {/* <img src="/Logo.jpg" alt="" className=" w-10" /> */}
      <h1 className="font-bold text-2xl">Squid</h1>
