...
export function MessageInput({ setNewMessage, newMessage, handleSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative px-3 py-2 flex items-end justify-between ">
      <input type="file" ref={fileRef} onChange={handleFileChange} style={{ display: 'none' }} />
      <button onClick={handleAddFileClick} type="button" href="#" className="p-2">
